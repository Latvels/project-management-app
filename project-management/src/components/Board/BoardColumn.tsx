            ...
            display: 'flex',
              ...
              {viewButtonEdit ? (
                <Box sx={{
                  ...
                  >
                    <ToggleButton size={'small'} value='submit' onClick={onClickSubmit}><Tooltip title={t('boardPage:submit')}><EditIcon fontSize="inherit" /></Tooltip></ToggleButton>
                    <ToggleButton size={'small'} value='cancel' onClick={onClickCancel}><Tooltip title={t('boardPage:cancel')}><EditOffIcon fontSize="inherit" /></Tooltip></ToggleButton>
                  </ToggleButtonGroup>
                </Box>
              ) : (
                <Box sx={{
                  ...
                  left: 0,
                  padding: '0.7rem'
                }} onClick={onChangeCapture}>{id}</Box>
              )}
            <Box>
